...
import yoonhuijung.dogcareproject.RecyclerCollection.adapter.UpdateAdapter;
...
import yoonhuijung.dogcareproject.get.AppConfig;
...
public class UpdateAccount extends AppCompatActivity {
    ...
    public void setRecyclerview()
    {
        ...
        mAdapter = new UpdateAdapter(getApplicationContext(),myDateset);
