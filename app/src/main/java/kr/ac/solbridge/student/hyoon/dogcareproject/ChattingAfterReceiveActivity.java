...
import kr.ac.solbridge.student.hyoon.dogcareproject.apprtc.ConnectActivity;
...
import kr.ac.solbridge.student.hyoon.dogcareproject.chatting.ChattingAdapter;
...
public class ChattingAfterReceiveActivity extends AppCompatActivity implements View.OnClickListener,ReceiverThreadmain.OnReceiveListener {
    ...
    ArrayList<getchatlist> arraychatlist;
...
//        startActivity(intent);
    ...
    private void getCarrerdataFromSever()
    {
        ...
        Call<List<getchatlist>> call = mapiconfig.getchatPersonsData(name);
        call.enqueue(new Callback<List<getchatlist>>() {
            ...
            public void onResponse(Call<List<getchatlist>> call, Response<List<getchatlist>> response) {
                ...
                {
                    arraychatlist.add(new getchatlist(getchatlists.get(i).getSender_image(),getchatlists.get(i).getSender_chat(),getchatlists.get(i).getMsg_chat(),getchatlists.get(i).getSender_time()));
                }
                setRecyclerView();
            }
